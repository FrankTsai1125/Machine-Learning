...
from peft.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties,sce_mask,sce_weight,sce
    ...
    **Attributes**:
        ...
        if combination_type in ("linear", "ties", "dare_ties", "dare_linear", "magnitude_prune", "sce"):
            ...
            if len(set(adapters_ranks)) != 1:
                raise ValueError(
                    ...
                    "dare_linear, magnitude_prune, sce."
                )
    ...
    def add_weighted_adapter(
        ...
        Args:
            ...
            combination_type (`str`):
                ...
                `dare_ties_svd`, `dare_linear_svd`, `magnitude_prune`, `magnitude_prune_svd`, `sce`, `sce_svd`]. When using the `cat`
            ...
            density (`float`, *optional*):
                ...
                `magnitude_prune`, `magnitude_prune_svd`, `sce`, `sce_svd`]
            majority_sign_method (`str`):
                The method, should be one of ["total", "frequency"], to use to get the magnitude of the sign values.
                Should be used with [`ties`, `ties_svd`, `dare_ties`, `dare_ties_svd`, `sce`, `sce_svd`]
        """
        ...
        for key in key_list:
            ...
            if isinstance(target, LoraLayer):
                ...
                elif combination_type == "sce_svd":
                    target_lora_A.data, target_lora_B.data = self._sce_svd_generalized_task_arithmetic_weighted_adapter(
                        combination_type,
                        adapters,
                        weights,
                        new_rank,
    ...
    def _svd_generalized_task_arithmetic_weighted_adapter(
        ...
        if combination_type == "svd":
            ...
            delta_weight = sce(delta_weight, density, majority_sign_method)
        else:
    ...
    def _sce_svd_generalized_task_arithmetic_weighted_adapter(
        self,
        combination_type,
        adapters,
        weights,
